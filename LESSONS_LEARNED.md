...
> **גרסה:** 3.6 - AI_QUICK_START Integration + Code Review Automation + Sticky Notes Design
...
- [15 עקרונות הזהב](#-15-עקרונות-הזהב) ⭐ קרא קודם!
- [בעיות נפוצות - פתרון מהיר](#-בעיות-נפוצות---פתרון-מהיר)
- **⚡ AI_QUICK_START.md** - הוראות לסוכן AI + Code Review אוטומטי ← [קרא בקבצים קשורים](#קבצים-קשורים)
...
15. **AI_QUICK_START pattern** → תן לסוכן בתחילת כל שיחה ⚡ חדש! ← [AI_QUICK_START.md](AI_QUICK_START.md)
...
| 🔴 Access denied לקבצים? ⭐ | **נתיב מלא מהפרויקט!** `C:\projects\salsheli\...` |
...
| קובץ | מטרה | מתי לקרוא |
|------|------|----------|
| **AI_QUICK_START.md** ⭐ | הוראות לסוכן AI + Code Review אוטומטי | **תן לסוכן בתחילת כל שיחה!** |
| **BEST_PRACTICES.md** ⭐ | Best practices לקוד ועיצוב | לפני כתיבת קוד חדש |
| **STICKY_NOTES_DESIGN.md** ⭐ | מערכת עיצוב מלאה בהשראת פתקים | לפני עבודה על UI |
| **WORK_LOG.md** | היסטוריית שינויים + לקחים | בתחילת היום |
| **AI_DEV_GUIDELINES.md** | הנחיות מפורטות לסוכני AI | אם עובדים עם AI |
| **README.md** | תיעוד כללי + Quick Start | Getting Started |

---

**לסיכום:** הפרויקט עבר טרנספורמציה מלאה ב-06-15/10/2025.
- כל הדפוסים כאן מבוססים על קוד אמיתי ומתועדים היטב
- AI_QUICK_START.md מספק automation של Code Review
- Sticky Notes Design System = UI unique וחדשני
- כל פיתוח חדש צריך לקרוא את ה-15 עקרונות הזהב קודם! ⭐

**גרסה 3.6 (15/10/2025) מוסיפה:** ⭐ חדש!
- ✅ **AI_QUICK_START Integration** - Reference כלל זהב #15
- ✅ **Sticky Notes Design System** - מערכת עיצוב מלאה
- ✅ **Code Review Automation** - AI עושה review אוטומטי
- ✅ **Batch Firestore Limits** - מגבלת 500 פעולות ⚠️
- ✅ **Race Condition signUp** - דגל `_isSigningUp` למניעת שכפול
- ✅ **File Paths Pattern** - תמיד `C:\projects\salsheli\...`
