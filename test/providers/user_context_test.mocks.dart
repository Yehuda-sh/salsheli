...
// in memozap/test/providers/user_context_test.dart.
...
class MockUserRepository extends _i1.Mock implements _i4.UserRepository {
  ...
  @override
  _i5.Future<_i2.UserEntity?> fetchUser(String? userId) => (super.noSuchMethod(
        Invocation.method(
          #fetchUser,
          [userId],
        ),
  ...
  @override
  _i5.Future<bool> existsUser(String? userId) => (super.noSuchMethod(
        Invocation.method(
          #existsUser,
          [userId],
        ),
  ...
  @override
  _i5.Future<List<_i2.UserEntity>> getAllUsers() => (super.noSuchMethod(
        Invocation.method(
          #getAllUsers,
          [],
        ),
  ...
  @override
  _i5.Future<_i2.UserEntity?> findByEmail(String? email) => (super.noSuchMethod(
        Invocation.method(
          #findByEmail,
          [email],
        ),
  ...
  @override
  _i5.Future<void> updateLastLogin(String? userId) => (super.noSuchMethod(
        Invocation.method(
          #updateLastLogin,
          [userId],
        ),
