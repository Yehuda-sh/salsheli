...
### 📸 Screenshot חושף מה שקריאת קוד מפספסת
- בסבב 3 של `action_center_card.dart`, קריאת הקוד 2 פעמים לא חשפה: באג "1 מוצר אחד נגמר" (chip מוסיף count + string סינגולר עם "אחד" = כפילות), היררכיית צבעים הפוכה (pink רך ל-critical, אדום ל-overdue), התנגשות עם הבאנר הוורוד מעל, וחוסר התאמה לשפת sticky-notes.
- כל אלה **בלתי-נראים בקוד** — צריך עיניים על המסך.
- **כלל אצבע:** קבצי UI מורכבים (chips, cards, dialogs, banners) — לפני סבב סקירה, אם המשתמש לא צירף screenshot, **לבקש בעדינות** ("אם יש לך צילום מסך של הקובץ במצב טיפוסי, יעזור לסבב הזה"). הסיכוי שתתפוס באגים ויזואליים שלא בקוד עולה דרמטית.
- דברים שעיניים תופסות שקוד לא: כפילויות טקסט סינגולר/plural, היררכיית צבעים בפועל, התנגשויות בין widget לסביבתו, חוסר התאמה לשפת עיצוב, asymmetry ב-layout, dark-mode contrast.
