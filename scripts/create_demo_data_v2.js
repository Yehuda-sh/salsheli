 ...
 * 
 * ⚠️ חשוב: הקטגוריות כאן מתאימות למה שב-Firestore בפועל!
 * המקור: fetch_shufersal_products.dart (guessCategory function)
 * 
 * הקטגוריות ב-Firestore:
 * - מוצרי חלב, מאפים, ירקות, פירות, בשר ודגים
 * - אורז ופסטה, שמנים ורטבים, תבלינים ואפייה
 * - ממתקים וחטיפים, משקאות, קפה ותה
 * - מוצרי ניקיון, היגיינה אישית
 * - שימורים, קפואים, אחר
 */
const CATEGORY_MAPPING = {
  ...
  'fruits': ['פירות'],
  'bakery': ['מאפים'],
  'dry_goods': ['אורז ופסטה', 'תבלינים ואפייה', 'שמנים ורטבים', 'שימורים'],
