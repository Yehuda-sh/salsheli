...
- ❓ מה קורה אם יש הרבה מאוד רשימות?
- ❓ האם ה-Tutorial מופיע רק בפעם הראשונה?
...
```
       ...
       ┌───────────────────┼───────────────────┐
       ↓                   ↓                   ↓
  לחיצה על           לחיצה על           לחיצה על
    רשימה          "+ רשימה חדשה"         📬
       ↓                   ↓                   ↓
┌──────────────┐   ┌──────────────┐   ┌─────────────────┐
│ ListDetails  │   │ CreateList   │   │PendingGroupInvites│
│ (פרטי רשימה) │   │(יצירת רשימה) │   │(הזמנות ממתינות) │
└──────────────┘   └──────────────┘   └─────────────────┘
```
