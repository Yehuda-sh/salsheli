...
- ❌ **העברת בעלות** - לא ממומש. הקוד חוסם מפורשות שינוי לתפקיד owner ב-[firebase_group_repository.dart](../../../lib/repositories/firebase_group_repository.dart):318
- ❌ **התראות Push** - אין FCM. רק התראות in-app שנשמרות ב-Firestore ומוצגות כשפותחים את האפליקציה
