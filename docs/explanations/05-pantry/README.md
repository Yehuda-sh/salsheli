...
1. **אחרי קנייה** - שאלה: "להוסיף למזווה?"
...
## 🛒 הוספה אוטומטית מקנייה

**בסיום קנייה מופיעה שאלה:**
...
**למה ככה?**
- לא כל מה שקונים הולך למזווה (סבון, נייר טואלט...)
- המשתמש בוחר מה להוסיף
- פשוט ומהיר
...
**הערה חשובה:** תאריך תפוגה הוא אופציונלי!

רוב המשתמשים לא יכניסו תאריך תפוגה - וזה בסדר.
למי שכן רוצה לעקוב:

**מה קורה כשתאריך עבר:**
1. סימון אדום "⚠️ פג תוקף!" ליד המוצר
2. התראת Push (אם מופעלות התראות)
3. המוצר **לא** נמחק אוטומטית - רק סימון ויזואלי

**למה לא מוחקים אוטומטית?**
- לפעמים תאריך תפוגה הוא "עד" ולא "פג"
...
3. לא ניתן להוסיף/לערוך עד שיש חיבור
...
**למה?**
- מזווה יכול להכיל יותר פריטים מרשימת קניות
- 500 זה מספיק גם למשפחות גדולות
- שמירה על ביצועים טובים

**מה קורה כשמגיעים למקסימום?**
- הודעה: "הגעת למקסימום 500 פריטים במזווה"
...
- ⚠️ **תאריך תפוגה** - סימון אדום + התראת Push (אם יש תאריך)
- ⚠️ **הוספה מקנייה** - שאלה "להוסיף למזווה?" בסיום
- ⚠️ **עריכת פריט** - דיאלוג עריכה מלא
- ⚠️ **הגבלת 500 פריטים** - הודעה כשמגיעים למקסימום
- ⚠️ **התראות מלאי נמוך** - Push notification
