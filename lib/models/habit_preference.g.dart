...
HabitPreference _$HabitPreferenceFromJson(Map<String, dynamic> json) =>
    HabitPreference(
      ...
      lastPurchased:
          const TimestampConverter().fromJson(json['last_purchased'] as Object),
      createdDate:
          const TimestampConverter().fromJson(json['created_date'] as Object),
      updatedDate:
          const TimestampConverter().fromJson(json['updated_date'] as Object),
    );

Map<String, dynamic> _$HabitPreferenceToJson(HabitPreference instance) =>
    <String, dynamic>{
      'id': instance.id,
      ...
      'last_purchased':
          const TimestampConverter().toJson(instance.lastPurchased),
