...
Receipt _$ReceiptFromJson(Map<String, dynamic> json) => Receipt(
      ...
      createdDate: const NullableFlexibleDateTimeConverter()
          .fromJson(json['created_date']),
...
Map<String, dynamic> _$ReceiptToJson(Receipt instance) => <String, dynamic>{
      ...
      'created_date': const NullableFlexibleDateTimeConverter()
