// lib/providers/shopping_lists_provider.dart — Shopping lists provider — CRUD, item management, collaborative shopping, real-time sync
...
class ShoppingListsProvider with ChangeNotifier {
  ...
  Future<ShoppingList> createList({
    ...
    try {
      ...
      _errorMessage = userFriendlyError(e, context: 'createList');
      _notifySafe();
      rethrow;
    }
  }
  ...
  Future<void> deleteList(String id) async {
    ...
    try {
      ...
      _errorMessage = userFriendlyError(e, context: 'deleteList');
      _notifySafe();
      rethrow;
    }
  }
  ...
  Future<void> updateList(ShoppingList updated) async {
    ...
    try {
      ...
      _errorMessage = userFriendlyError(e, context: 'updateList');
      _notifySafe();
      rethrow;
    }
  }
  ...
  Future<void> shareListToHousehold(String listId) async {
    ...
    try {
      ...
      _errorMessage = userFriendlyError(e, context: 'shareList');
      _notifySafe();
      rethrow;
    }
  }
  ...
  Future<void> startCollaborativeShopping(String listId, String userId) async {
    ...
    try {
      ...
      _errorMessage = userFriendlyError(e, context: 'startShopping');
      _notifySafe();
      rethrow;
    }
  }
  ...
  Future<void> joinCollaborativeShopping(String listId, String userId) async {
    ...
    try {
      ...
      _errorMessage = userFriendlyError(e, context: 'joinShopping');
      _notifySafe();
      rethrow;
    }
  }
  ...
  Future<void> leaveCollaborativeShopping(String listId, String userId) async {
    ...
    try {
      ...
      _errorMessage = userFriendlyError(e, context: 'leaveShopping');
      _notifySafe();
      rethrow;
    }
  }
  ...
  Future<void> markItemAsChecked(
    ...
    try {
      ...
      _errorMessage = userFriendlyError(e, context: 'toggleItem');
      _notifySafe();
      rethrow;
    }
  }
  ...
  Future<void> updateItemStatus(
    ...
    try {
      ...
      _errorMessage = userFriendlyError(e, context: 'updateItemStatus');
      _notifySafe();
      rethrow;
    }
  }
  ...
  Future<void> cleanupAbandonedSessions() async {
    ...
    try {
      ...
      _errorMessage = userFriendlyError(e, context: 'cleanupSessions');
      _notifySafe();
      rethrow;
    }
  }
