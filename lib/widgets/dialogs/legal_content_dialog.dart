...
1. הגדרות
"האפליקציה" — אפליקציית MemoZap לניהול רשימות קניות ומזווה משפחתי.
"המשתמש/ת" — כל מי שמתקין/ה או משתמש/ת באפליקציה.
"תוכן משתמש" — רשימות קניות, פריטי מזווה, קבלות, ומידע אחר שהמשתמש/ת מזין/ה.

2. תיאור השירות
MemoZap מאפשרת ניהול רשימות קניות משותפות, מעקב אחר מלאי מזווה ביתי, שיתוף רשימות בין בני משפחה, שמירת היסטוריית קניות, וקבלת הצעות חכמות לקניות על בסיס צריכה.
...
4. שימוש מותר ואסור
מותר: שימוש אישי ומשפחתי לניהול קניות ומזווה.
...
• מידע משותף עם בני משפחה/קבוצה — רק תוכן שבחרת לשתף (רשימות, מזווה).
