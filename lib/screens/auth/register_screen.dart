...
class _RegisterScreenState extends State<RegisterScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _askHouseholdName(UserContext userContext) async {
    ...
    try {
      ...
      // generated by household_naming so the rest of the app (invite
      // flow, notifications, list-share copy) never has to deal with a
      // null householdName. The user can rename later from Settings;
      // the household_id is the actual anchor, not this string.
      final name = (result != null && result.isNotEmpty)
          ? result
          : generateDefaultHouseholdName();
      try {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Builder(builder: (context) {
                              final ctaBg = Theme.of(context).extension<AppBrand>()?.success ?? cs.primary;
