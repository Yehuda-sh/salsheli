...
class WelcomeStrings {
  ...
  String get group2Title => 'תמיד תדעו מה יש';
  String get group2Question => 'מזווה דיגיטלי שמתריע כשמשהו עומד להיגמר';
  String get group2Feature1 => 'מלאי 📊';
  String get group2Feature2 => 'תזכורות ⏰';
  String get group3Emoji => '👨‍👩‍👧‍👦';
  String get group3Title => 'קנו בלי לשכוח';
  String get group3Question => 'שתפו רשימות עם בני הבית — כולם מסונכרנים';
  ...
  String get benefit1Subtitle => 'כולם רואים, כולם מעדכנים';
  String get benefit2Title => 'קניות + מטלות ביחד';
  String get benefit2Subtitle => 'רשימה אחת לכל מה שצריך';
  String get benefit3Title => 'מזווה חכם';
  String get benefit3Subtitle => 'יודע מה חסר ומתריע בזמן';
...
class LegalStrings {
  ...
  String get lastUpdated => 'עדכון אחרון: מרץ 2026';

  // ═══════════════════════════════════════════════════════════════════════════
  // תנאי שימוש — סיכום + סעיפים
  // ═══════════════════════════════════════════════════════════════════════════

  String get termsOfServiceSummary =>
      'בקצרה: MemoZap היא אפליקציה לניהול קניות ומזווה ביתי. '
      'התוכן שלך שייך לך, ואנו שומרים עליו בשרתים מאובטחים. '
      'תוכל/י למחוק את חשבונך ואת כל הנתונים בכל עת.';

  // --- 1. הגדרות ---
  String get termsSectionDefinitions => 'הגדרות';
  String get termsSectionDefinitionsContent =>
  ...
  // --- 2. תיאור השירות ---
  String get termsSectionServiceDescription => 'תיאור השירות';
  String get termsSectionServiceDescriptionContent =>
      'MemoZap מאפשרת ניהול רשימות קניות משותפות, מעקב אחר מלאי מזווה ביתי, '
      'שיתוף רשימות בין חברי הבית, שמירת היסטוריית קניות, '
      'וקבלת הצעות חכמות לקניות על בסיס צריכה.';

  // --- 3. חשבון משתמש ---
  String get termsSectionAccount => 'חשבון משתמש';
  String get termsSectionAccountContent =>
  ...
  // --- 4. שימוש מותר ואסור ---
  String get termsSectionUsageRules => 'שימוש מותר ואסור';
  String get termsSectionUsageRulesContent =>
      'מותר: שימוש אישי וביתי לניהול קניות ומזווה.\n\n'
      'אסור: שימוש מסחרי, העתקה או הפצה של האפליקציה, '
      'ניסיון לפרוץ או לשבש את השירות, העלאת תוכן פוגעני או בלתי חוקי.';

  // --- 5. תוכן משתמש ---
  String get termsSectionUserContent => 'תוכן משתמש';
  String get termsSectionUserContentContent =>
  ...
  // --- 6. קניין רוחני ---
  String get termsSectionIntellectualProperty => 'קניין רוחני';
  String get termsSectionIntellectualPropertyContent =>
      'כל הזכויות באפליקציה, בעיצוב, בקוד ובתוכן שאינו תוכן משתמש '
      'שמורות למפתחי MemoZap.';

  // --- 7. הגבלת אחריות ---
  String get termsSectionLiability => 'הגבלת אחריות';
  String get termsSectionLiabilityContent =>
      'האפליקציה מסופקת "כמות שהיא" (AS IS). איננו אחראים ל:\n'
      '• נזקים ישירים או עקיפים הנובעים מהשימוש באפליקציה.\n'
      '• אובדן נתונים כתוצאה מתקלות טכניות.\n'
      '• דיוק המחירים או המידע המוצג.';

  // --- 8. זמינות השירות ---
  String get termsSectionAvailability => 'זמינות השירות';
  String get termsSectionAvailabilityContent =>
      'אנו שואפים לזמינות מלאה אך לא מתחייבים לכך. '
      'ייתכנו הפסקות לתחזוקה או שדרוגים.';

  // --- 9. שינויים בתנאים ---
  String get termsSectionChanges => 'שינויים בתנאים';
  String get termsSectionChangesContent =>
      'אנו רשאים לעדכן תנאים אלה מעת לעת. שינויים מהותיים יפורסמו באפליקציה. '
      'המשך השימוש לאחר שינוי מהווה הסכמה לתנאים המעודכנים.';

  // --- 10. דין חל ---
  String get termsSectionLaw => 'דין חל וסמכות שיפוט';
  String get termsSectionLawContent =>
      'על תנאים אלה יחול הדין הישראלי. '
      'סמכות השיפוט הבלעדית נתונה לבתי המשפט בירושלים.';

  // --- 11. יצירת קשר ---
  String get termsSectionContact => 'יצירת קשר';
  String get termsSectionContactContent =>
      'לשאלות או בירורים: memozap.app@gmail.com';

  // ═══════════════════════════════════════════════════════════════════════════
  // תנאי שימוש — טקסט מלא (backward compatible)
  // ═══════════════════════════════════════════════════════════════════════════
...
1. הגדרות
$termsSectionDefinitionsContent

2. תיאור השירות
$termsSectionServiceDescriptionContent

3. חשבון משתמש
$termsSectionAccountContent

4. שימוש מותר ואסור
$termsSectionUsageRulesContent

5. תוכן משתמש
$termsSectionUserContentContent

6. קניין רוחני
$termsSectionIntellectualPropertyContent

7. הגבלת אחריות
$termsSectionLiabilityContent

8. זמינות השירות
$termsSectionAvailabilityContent

9. שינויים בתנאים
$termsSectionChangesContent

10. דין חל וסמכות שיפוט
$termsSectionLawContent

11. יצירת קשר
$termsSectionContactContent''';

  // ═══════════════════════════════════════════════════════════════════════════
  // מדיניות פרטיות — סיכום + סעיפים
  // ═══════════════════════════════════════════════════════════════════════════

  String get privacyPolicySummary =>
      'בקצרה: אנו אוספים רק את המידע הנדרש להפעלת השירות. '
      'לא נמכור את המידע שלך לצדדים שלישיים. '
      'הנתונים מוצפנים ומאוחסנים בשרתי Google Cloud באירופה.';

  // --- 1. מידע שאנו אוספים ---
  String get privacySectionDataCollected => 'מידע שאנו אוספים';
  String get privacySectionDataCollectedContent =>
      ...
      '• נתוני שימוש אנונימיים (Analytics)\n'
      '• מידע על קריסות ושגיאות\n\n'
      'מידע שאיננו אוספים:\n'
      '• מיקום גיאוגרפי\n'
      '• אנשי קשר מהמכשיר\n'
  ...
  String get privacySectionDataUsage => 'כיצד אנו משתמשים במידע';
  ...
  // --- 3. שיתוף מידע ---
  String get privacySectionDataSharing => 'שיתוף מידע';
  String get privacySectionDataSharingContent =>
      '• לא נמכור ולא נשכיר את המידע שלך לצדדים שלישיים.\n'
      '• מידע משותף עם חברי הבית — רק תוכן שבחרת לשתף (רשימות, מזווה).\n'
      '• ספקי שירות — Firebase (Google) לאחסון ואימות.\n'
      '• דרישה חוקית — נשתף מידע רק אם נדרש על פי צו בית משפט או חוק.';

  // --- 4. אחסון ואבטחה ---
  String get privacySectionSecurity => 'אחסון ואבטחה';
  ...
  // --- 5. שמירת מידע ---
  String get privacySectionRetention => 'שמירת מידע';
  String get privacySectionRetentionContent =>
  ...
  // --- 6. זכויותיך ---
  String get privacySectionRights => 'זכויותיך';
  String get privacySectionRightsContent =>
      ...
      '• זכות ניוד — לייצא את הנתונים שלך\n'
      '• זכות התנגדות — להפסיק שימוש ב-Analytics\n\n'
      'למימוש זכויותיך: memozap.app@gmail.com';

  // --- 7. גיל מינימלי ---
  String get privacySectionMinAge => 'גיל מינימלי';
  String get privacySectionMinAgeContent =>
      'האפליקציה מיועדת לגילאי 13 ומעלה. '
      'איננו אוספים ביודעין מידע על ילדים מתחת לגיל 13.';

  // --- 8. שינויים במדיניות ---
  String get privacySectionChanges => 'שינויים במדיניות';
  String get privacySectionChangesContent =>
      'שינויים מהותיים יפורסמו באפליקציה לפחות 7 ימים לפני כניסתם לתוקף.';

  // --- 9. יצירת קשר ---
  String get privacySectionContact => 'יצירת קשר';
  String get privacySectionContactContent =>
      'לשאלות בנושא פרטיות: memozap.app@gmail.com';

  // ═══════════════════════════════════════════════════════════════════════════
  // מדיניות פרטיות — טקסט מלא (backward compatible)
  // ═══════════════════════════════════════════════════════════════════════════
...
1. מידע שאנו אוספים
$privacySectionDataCollectedContent

2. כיצד אנו משתמשים במידע
$privacySectionDataUsageContent

3. שיתוף מידע
$privacySectionDataSharingContent

4. אחסון ואבטחה
$privacySectionSecurityContent

5. שמירת מידע
$privacySectionRetentionContent

6. זכויותיך
$privacySectionRightsContent

7. גיל מינימלי
$privacySectionMinAgeContent

8. שינויים במדיניות
$privacySectionChangesContent

9. יצירת קשר
$privacySectionContactContent''';
}
