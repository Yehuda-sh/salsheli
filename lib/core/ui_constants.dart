...
/// Minimum tap target size — Apple HIG floor (Material recommends 48,
/// but 44 reads cleaner in dense layouts and matches what the iOS
/// guidelines have always asked for). Use this for ConstrainedBox /
/// minimumSize floors on tappable widgets.
...
const double kOpacityStrong = 0.7;  // Strong opacity (cards on textured bg, dimmed primary)
...
// Splash background — must stay in sync with flutter_native_splash colors
// in pubspec.yaml so the handoff from the Android native splash to
// IndexLoadingView is a visually identical surface (no purple flash).
